...
class InspectionRecordsViewTests(TestCase):
    ...
    def test_get_valid_restaurant_inspections(self):
        response = self.client.get(
            reverse("restaurant:inspection_history", args=(self.restaurant.id,))
        )
...
class RestaurantUtilsTests(TestCase):
                    ...
                    "reviews": [
                        {
                            ...
                            "rating": 5,
                            "text": "Went back again to this place since the "
                            "last time i visited the bay area 5 months "
                            "ago, and nothing has changed. Still the "
                            "sketchy Mission, Still the cashier...",
                            "time_created": "2016-08-29 00:41:13",
                        },
                        {
                            "id": "1JNmYjJXr9ZbsfZUAgkeXQ",
                            "rating": 4,
                            "text": 'The "restaurant" is inside a small deli '
                            "so there is no sit down area. Just grab "
                            "and go.\n\nInside, they sell individually "
                            "packaged ingredients so that you can...",
                        ...
                        },
                        {
                            ...
                            "your many delicious late night food "
                            "establishments and vibrant atmosphere.  I "
                            "miss the way you sound and smell on a...",
    ...
    def test_get_restaurant_list(self, mock_objects, mock_get_latest_inspection_record):
        # mock_objects.return_value = [create_restaurant('Gary Danko', '800 N Point St', '94109',
        # "WavvLdfdP6g8aZTtbBQHTw")] print(mock_objects.return_value[0:1])
        # #mock_get_latest_inspection_record.return_value = model_to_dict(create_inspection_records('11157',
        # 'Tacos El Paisa', '10040', '1548 St. Nicholas btw West 187th street and west 188th street, Manhattan, NY',
        # Compliance.skipped, 'No Seating', '2020-07-16 18:09:42')) #get_restaurant_list(0, 1) TODO
        pass
